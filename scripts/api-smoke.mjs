...
const device = await get("/api/onboarding/device-bind", { method: "POST", headers: { ...headers, "idempotency-key": "smoke-device-1" }, body: JSON.stringify({ fingerprint: "smoke-device-123456" }) });
